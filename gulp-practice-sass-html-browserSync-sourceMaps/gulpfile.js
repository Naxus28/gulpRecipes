...
gulp.task('sass', function() {
  gulp.src('app/sass/**/*.scss')
    .pipe(plugins.sourcemaps.init()) // source maps helps to debug css because it shows the scss source on the inspector, not the final minified version
    .pipe(plugins.sass())
    .pipe(plugins.concat('styles.min.css'))
    .pipe(plugins.minifyCss())
    .pipe(plugins.sourcemaps.write('.')) //  .map file to the same directory specified in 'gulp.dest' 
